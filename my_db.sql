...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 06, 2021 at 08:26 PM
...
CREATE TABLE `students` (
  ...
  `s_points` int(4) NOT NULL DEFAULT 0,
  `s_wrong_answers` int(4) NOT NULL DEFAULT 0,
  `s_level` int(1) NOT NULL DEFAULT 1
...
INSERT INTO `students` (`sid`, `s_name`, `s_password`, `s_points`, `s_wrong_answers`, `s_level`) VALUES
(30, 'nima', 'nima', 0, 0, 1);
...
INSERT INTO `teacher` (`tid`, `t_name`, `t_password`) VALUES
(1, 'admin', 'admin');
...
ALTER TABLE `students`
  ...
  ADD UNIQUE KEY `s_name_2` (`s_name`),
...
--
ALTER TABLE `teacher`
  MODIFY `tid` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- Database: `phpmyadmin`
--
...
('root', '[{\"db\":\"my_db\",\"table\":\"students\"},{\"db\":\"my_db\",\"table\":\"teacher\"}]');
...
('root', '2021-06-06 18:25:41', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":269}');
